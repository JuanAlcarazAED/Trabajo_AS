...
compresion_DWT <- function(ruta_imagen, ruta_imagen_comp = "data_comp", extension_comp = "jpg", politica_umbral = "universal") {
  ...
  ruta_salida <- file.path(ruta_imagen_comp, paste0(nombre_archivo, "_DWT.", extension_comp))
