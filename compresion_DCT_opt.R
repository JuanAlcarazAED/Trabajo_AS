...
compresion_DCT_opt <- function(ruta_imagen, ruta_imagen_comp = "data_comp", extension_comp = "jpg", nivel_compresion = 0.95) {
  ...
  ruta_salida <- file.path(ruta_imagen_comp, paste0(nombre_archivo, "_DCT.", extension_comp))
