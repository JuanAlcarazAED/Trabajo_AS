...
Después de cada iteración se reduce a la mitad la cota usada para medir la significancia y se repite el proceso con la nueva cota. El algoritmo finaliza cuando la cota toma un valor menos o igual a $1$.
