...
author: "Juan Alcaraz, Adrián Carrasco, Fabian Calvo, Javier Herrero, Clara Montalvá"
date: "`r Sys.Date()`"
output:
...
max_iter <- 20
factor <- 1
bitstream <- SPIHT_Codificar(W * factor, max_bits = max_bits, max_iter = max_iter)
...
dwt_rec <- Desensamblar(W_rec / factor)
...
save.image(as.cimg(img_rec), file = paste("Reconstruccion_d8_j8_19it.jpeg",sep=""))
##############################################
