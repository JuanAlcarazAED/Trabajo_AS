...
# Expandir los valores
expand_to_length <- function(coefs, target_len) {
  # Expandir los valores para que no se queden a la mitad
...
coef_df <- lapply(1:n.levels, function(i) {
...
ggplot(coef_df, aes(x = time, y = level, fill = coef)) +
  geom_raster() +
  scale_fill_gradient2(low = "white", high = "black") +
  labs(title = "Wavelet Detail Coefficients Heatmap",
       x = "Tiempo (muestras)",
       y = "Nivel wavelet") +
  theme_minimal() +
  theme(
