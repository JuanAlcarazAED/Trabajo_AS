...
save.image(img, 'IMAGENES/foto_de_prueba_guardada.jpg', quality = 0.8)
...
save.image(img, 'IMAGENES/dibujo.jpg', quality = 1)
# Partiendo de una foto .png sí
```
...
tic()
compresion_SPIHT('IMAGENES/boats.png')
toc()
```
